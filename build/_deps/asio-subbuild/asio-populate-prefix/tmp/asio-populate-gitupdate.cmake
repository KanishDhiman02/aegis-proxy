...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "asio-1-30-2"
  WORKING_DIRECTORY "/Users/kanishdhiman/Desktop/proxy/build/_deps/asio-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/kanishdhiman/Desktop/proxy/build/_deps/asio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/kanishdhiman/Desktop/proxy/build/_deps/asio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
